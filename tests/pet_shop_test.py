...
class TestPetShop(unittest.TestCase):
    ...
    def test_customer_can_afford_pet__sufficient_funds(self): #Done!
        customer = self.customers[0]
        can_buy_pet = customer_can_afford_pet(customer, self.new_pet)
        self.assertEqual(True, can_buy_pet)

    def test_customer_can_afford_pet__insufficient_funds(self): #Done!
        customer = self.customers[1]
        can_buy_pet = customer_can_afford_pet(customer, self.new_pet)
        self.assertEqual(False, can_buy_pet)

    def test_customer_can_afford_pet__exact_funds(self): #Done!
    ...
    def test_sell_pet_to_customer__pet_found(self): #Done!
        customer = self.customers[0]
        pet = find_pet_by_name(self.cc_pet_shop,"Arthur")
    ...
    # @unittest.skip("delete this line to run the test")
    def test_sell_pet_to_customer__insufficient_funds(self): #Done!
        customer = self.customers[1]
        pet = find_pet_by_name(self.cc_pet_shop,"Arthur")
